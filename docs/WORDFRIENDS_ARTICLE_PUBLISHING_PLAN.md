...
| 9 | `WORDFRIENDS_ARTICLE_CUSTOMER_PORTAL_GUIDE.md` | 고객 포털 사용 안내: 내 사이트와 문의 상태 확인하기 | FAQ/공지 | `customer-portal-guide` | 고객포털 / 문의 / 가이드FAQ | 발행 완료 |
| 10 | `WORDFRIENDS_ARTICLE_CONTENT_OPERATION_ROUTINE.md` | 콘텐츠 운영 루틴 만들기: 발행보다 먼저 정할 기준 | 수익형 사이트 운영 | `content-operation-routine` | 서비스 / 가이드FAQ / 문의 | 초안 준비 |
