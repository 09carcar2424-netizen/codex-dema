...
(function () {
  ...
  function ensurePortalLinks() {
    ...
    var publicLinks = [
      ['Wordfriends\ub294', WordfriendsSiteOps.homeUrl || '/', ['HOME', '\ud648']],
  ...
  function renameHomeTitle() {
    var homePath = normalizePath(WordfriendsSiteOps.homeUrl || '/');
    var currentPath = normalizePath(window.location.pathname);
    ...
    var label = (heading.textContent || '').replace(/\s+/g, '').trim().toLowerCase();
    if (label === 'home' || label === '\ud648') {
      heading.textContent = 'Wordfriends\ub294';
    }
  }
...
function wordfriends_siteops_portal_styles() {
    ...
    wp_add_inline_style('wordfriends-siteops-portal', '
      ...
      body.wordfriends-article-page .wp-site-blocks,
      ...
      body.wordfriends-article-page header,
      body.wordfriends-article-page footer {
        background: #061316;
        color: #d8f2ee;
      }
      body.wordfriends-article-page main {
      ...
      body.wordfriends-article-page main.has-global-padding,
      body.wordfriends-article-page .entry-content.has-global-padding,
      body.wordfriends-article-page .wp-block-post-content.has-global-padding {
      ...
      body.wordfriends-article-page .wp-block-post-author,
      body.wordfriends-article-page .wp-block-post-date,
      body.wordfriends-article-page .wp-block-post-terms,
      body.wordfriends-article-page .taxonomy-category,
      ...
      body.wordfriends-article-page .wp-block-post-author a,
      body.wordfriends-article-page .wp-block-post-date a,
      body.wordfriends-article-page .wp-block-post-terms a,
      body.wordfriends-article-page .taxonomy-category a,
      body.wordfriends-article-page .entry-meta a,
      body.wordfriends-article-page .post-meta a {
        color: #8de8d7;
        text-underline-offset: 4px;
      }
      body.wordfriends-article-page .entry-content,
      ...
      body.wordfriends-article-page .wordfriends-article > *:first-child {
        margin-top: 0;
      }
      body.wordfriends-article-page .wordfriends-article h2,
      body.wordfriends-article-page .wordfriends-article h3,
      body.wordfriends-article-page .entry-content h2,
      body.wordfriends-article-page .entry-content h3,
      body.wordfriends-article-page .wp-block-post-content h2,
      body.wordfriends-article-page .wp-block-post-content h3 {
        margin: 30px 0 10px;
        color: #f3fffd;
        font-weight: 900;
        letter-spacing: 0;
      ...
      body.wordfriends-article-page .entry-content p,
      body.wordfriends-article-page .entry-content li,
      body.wordfriends-article-page .wp-block-post-content p,
      body.wordfriends-article-page .wp-block-post-content li {
        color: #c7e8e4;
      }
      body.wordfriends-article-page .entry-content ul,
      body.wordfriends-article-page .entry-content ol,
      body.wordfriends-article-page .wp-block-post-content ul,
      body.wordfriends-article-page .wp-block-post-content ol {
        padding-left: 22px;
      }
      body.wordfriends-article-page .entry-content a,
      body.wordfriends-article-page .wp-block-post-content a,
      body.wordfriends-article-page header a,
      body.wordfriends-article-page footer a {
        color: #8de8d7;
        text-underline-offset: 4px;
      }
      body.wordfriends-article-page .entry-content a:hover,
      body.wordfriends-article-page .wp-block-post-content a:hover,
      body.wordfriends-article-page header a:hover,
      body.wordfriends-article-page footer a:hover {
        color: #4ad6b4;
      }
      ...
      body.wordfriends-article-page .wp-block-post-navigation-link a,
      body.wordfriends-article-page .post-navigation-link-next a,
      body.wordfriends-article-page .post-navigation-link-previous a {
        display: inline-flex;
        align-items: center;
        gap: 6px;
        color: #8de8d7;
      ...
      body.wordfriends-article-page input[type="email"],
      body.wordfriends-article-page input[type="url"] {
        border: 1px solid #24474d;
        border-radius: 8px;
        background: #071a1f;
        color: #d8f2ee;
      }
      body.wordfriends-article-page input[type="submit"],
      body.wordfriends-article-page button[type="submit"] {
        border: 0;
        border-radius: 999px;
        background: #28a987;
        color: #05201b;
      ...
      body.wordfriends-article-page .wp-block-navigation__responsive-container.is-menu-open {
      ...
      body.wordfriends-article-page .wp-block-navigation__responsive-container.is-menu-open .wp-block-navigation__responsive-container-content {
      ...
      body.wordfriends-article-page .wp-block-navigation__responsive-container.is-menu-open .wp-block-navigation__container {
      ...
      body.wordfriends-article-page .wp-block-navigation__responsive-container.is-menu-open .wp-block-navigation-item {
        min-width: 0;
        width: 100%;
      }
      ...
      body.wordfriends-article-page .wp-block-navigation__responsive-container.is-menu-open a {
        display: flex;
        align-items: center;
        justify-content: center;
        width: 100%;
      ...
      body.wordfriends-article-page .wp-block-navigation__responsive-container-close {
        top: 22px;
        right: 22px;
        border: 1px solid #24474d;
        border-radius: 999px;
      ...
      .wordfriends-ai-orbit {
        ...
        border-radius: 50%;
        animation: wordfriends-orbit 14s linear infinite;
      }
      .wordfriends-ai-orbit:nth-child(2) {
        inset: 11%;
      ...
      .wordfriends-ai-robot {
        inset: 22%;
        border: 1px solid rgba(141, 232, 215, .44);
        border-radius: 8px;
        background:
        ...
        box-shadow: 0 0 34px rgba(53, 198, 165, .25);
      }
      .wordfriends-ai-robot::before,
      .wordfriends-ai-robot::after {
        content: "";
        position: absolute;
        top: 34%;
        width: 12px;
        ...
        border-radius: 50%;
        background: #8de8d7;
        box-shadow: 0 0 18px rgba(141, 232, 215, .8);
      }
      .wordfriends-ai-robot::before {
        left: 28%;
      }
      ...
      .wordfriends-ai-robot span {
        ...
        height: 5px;
        border-radius: 999px;
        background: linear-gradient(90deg, rgba(93, 224, 192, .18), #8de8d7, rgba(93, 224, 192, .18));
        transform: translateX(-50%);
        box-shadow: 0 0 16px rgba(141, 232, 215, .5);
      }
      .wordfriends-ai-robot strong {
        position: absolute;
        left: 50%;
        top: 12px;
        transform: translateX(-50%);
      ...
      .wordfriends-ai-map {
        opacity: .72;
        background:
          radial-gradient(ellipse at 28% 40%, transparent 0 17%, rgba(141, 232, 215, .22) 17.5% 18.4%, transparent 19%),
          radial-gradient(ellipse at 62% 47%, transparent 0 21%, rgba(141, 232, 215, .2) 21.5% 22.2%, transparent 23%),
          linear-gradient(90deg, rgba(141, 232, 215, .08) 1px, transparent 1px),
          linear-gradient(rgba(141, 232, 215, .08) 1px, transparent 1px);
      ...
      .wordfriends-ai-dot {
        ...
        border-radius: 50%;
        background: #5de0c0;
        box-shadow: 0 0 18px rgba(93, 224, 192, .9);
        animation: wordfriends-pulse 1.8s ease-in-out infinite;
      }
      .wordfriends-ai-dot-one { left: 14%; top: 38%; animation-delay: .1s; }
      .wordfriends-ai-dot-two { left: 36%; top: 17%; animation-delay: .45s; }
      .wordfriends-ai-dot-three { right: 18%; top: 43%; animation-delay: .8s; }
      .wordfriends-ai-dot-four { left: 56%; bottom: 14%; animation-delay: 1.1s; }
      .wordfriends-ai-dot-five { right: 32%; top: 24%; animation-delay: 1.35s; }
      .wordfriends-ai-dot-six { left: 25%; bottom: 28%; animation-delay: 1.6s; }
      .wordfriends-ai-label {
        position: absolute;
        border: 1px solid rgba(141, 232, 215, .36);
        border-radius: 999px;
        padding: 6px 9px;
        background: rgba(7, 26, 31, .86);
        color: #dffdf8;
        font-size: 10px;
        font-weight: 900;
        line-height: 1;
        box-shadow: 0 0 18px rgba(93, 224, 192, .08);
      }
      .wordfriends-ai-label-code { left: 0; top: 10%; }
      ...
      .wordfriends-tech-strip {
        display: flex;
        flex-wrap: wrap;
        gap: 8px;
        margin-top: 14px;
      }
      .wordfriends-tech-strip span {
        border: 1px solid #2a555c;
        border-radius: 999px;
        padding: 7px 10px;
        background: rgba(7, 26, 31, .78);
...
function wordfriends_siteops_home_shortcode($atts = []) {
    $atts = shortcode_atts([
        'title' => 'Wordfriends는',
        'subtitle' => '사이트 운영과 자동화를 함께 정리합니다.',
    ...
    <section class="wordfriends-auth wordfriends-home">
        <div class="wordfriends-home-hero">
            <div>
                <span class="wordfriends-home-eyebrow">WORDFRIENDS TECH OPERATIONS</span>
                <h2><?php echo esc_html($atts['title']); ?></h2>
                <p><?php echo esc_html($atts['subtitle']); ?></p>
                <p>WordPress 구축, 콘텐츠 운영, 고객 포털, 업무 자동화, 웹/API/DB 개발을 한 흐름으로 연결합니다.</p>
        ...
        <div class="wordfriends-home-trust">
            <article class="wordfriends-home-card">
                ...
                <strong>웹과 서버를 연결합니다</strong>
                <span>WordPress, API, 관리자 화면, 고객 포털을 운영 흐름에 맞게 정리합니다.</span>
            </article>
            <article class="wordfriends-home-card">
                <small>AUTOMATION</small>
                <strong>반복 업무를 자동화합니다</strong>
                <span>문의, 알림, 상태 점검, 데이터 기록을 한곳에서 확인할 수 있게 연결합니다.</span>
            </article>
            <article class="wordfriends-home-card">
                <small>DATA</small>
        ...
        <div class="wordfriends-home-grid">
            <a class="wordfriends-home-card" href="<?php echo esc_url(wordfriends_siteops_services_page_url()); ?>">
                <small>01</small>
                <strong>서비스</strong>
                <span>구축, 운영, 콘텐츠, 기술지원 범위를 확인합니다.</span>
            </a>
            ...
            <a class="wordfriends-home-card" href="<?php echo esc_url(wordfriends_siteops_guide_page_url()); ?>">
                ...
                <span>도메인, WordPress, AdSense, 운영 기준을 쉽게 정리합니다.</span>
            </a>
            <a class="wordfriends-home-card" href="<?php echo esc_url(wordfriends_siteops_dashboard_page_url()); ?>">
                <small>04</small>
                <strong>고객 포털</strong>
                <span>내 사이트, 문의, 전자계약, 알림 상태를 확인합니다.</span>
            </a>
        </div>

        <div class="wordfriends-home-steps wordfriends-home-method">
            <h3>Wordfriends가 하는 일</h3>
            <div class="wordfriends-home-ready-grid">
                <article>
                    <strong>사이트 운영 정리</strong>
                    <span>도메인, 호스팅, WordPress, 필수 페이지, 콘텐츠 운영 상태를 점검합니다.</span>
                </article>
                <article>
                    <strong>업무 자동화</strong>
                    <span>반복 확인, 알림, 문의 접수, 고객 포털 흐름을 자동화합니다.</span>
                </article>
                <article>
                    <strong>개발 지원</strong>
                    <span>웹, 서버, 데이터베이스, API 연동이 필요한 작업을 함께 정리합니다.</span>
                </article>
            </div>
        </div>

        <div class="wordfriends-home-final-cta">
            <strong>운영과 개발을 한 흐름으로 정리합니다</strong>
            <span>현재 준비 상태와 필요한 작업 범위를 알려주시면 다음 순서를 안내드립니다.</span>
            <div class="wordfriends-home-actions">
                <a class="wordfriends-button" href="<?php echo esc_url(wordfriends_siteops_question_page_url()); ?>">상담 문의</a>
        ...
        <p class="wordfriends-auth-small">Wordfriends는 운영 정리와 기술지원을 제공하며 수익, AdSense 승인, 트래픽, 검색 순위를 보장하지 않습니다.</p>
    </section>
    <?php
    return ob_get_clean();
}
